...
public class RedisUtils {
    ...
    public static Long inc(String key, int time, TimeUnit unit) {
        ...
        return stringRedisTemplate.execute(
                redisScript, Collections.singletonList(key), String.valueOf(unit.toSeconds(time)));
    }
    ...
    static <T> T toBeanOrNull(String json, Class<T> tClass) {
        return json == null ? null : JsonUtils.parseJson(json, tClass);
    }
    ...
    public static <T> void mset(Map<String, T> map, long time) {
        Map<String, String> collect =
                map.entrySet().stream()
                        .collect(
                                Collectors.toMap(Map.Entry::getKey, (e) -> objToStr(e.getValue())));
     ...
     * @return
     */
    public static Set<ZSetOperations.TypedTuple<String>> zRangeWithScores(
     ...
     * @return
     */
    public static Set<TypedTuple<String>> zRangeByScoreWithScores(
    ...
    public static Set<TypedTuple<String>> zReverseRangeWithScores(String key, long pageSize) {
        return stringRedisTemplate
                ...
                .reverseRangeByScoreWithScores(
                        key, Double.MIN_VALUE, Double.MAX_VALUE, 0, pageSize);
    }
    ...
    public static Set<TypedTuple<String>> zReverseRangeByScoreWithScores(
            String key, double max, long pageSize) {
        return stringRedisTemplate
                .opsForZSet()
                .reverseRangeByScoreWithScores(key, Double.MIN_VALUE, max, 1, pageSize);
    }
     ...
     * @return
     */
    public static Long zIntersectAndStore(
            String key, Collection<String> otherKeys, String destKey) {
